  ...
  if validarCampos then
    begin
      if txtNum2.Text = '0' then
        ...
        registrarLog('Erro divisão por zero');
        end
      else
        registrarLog('Divisão, num 1 = ' + txtNum1.Text + ', num2 = ' + txtNum2.Text + ', Resultado = ' + txtResultado.Text);
...
begin
  if validarCampos then
    begin
      ...
      registrarLog('Multiplicação, num 1 = ' + txtNum1.Text + ', num2 = ' + txtNum2.Text + ', Resultado = ' + txtResultado.Text);
    end;
end;
...
begin
  if validarCampos then
    begin
      ...
      registrarLog('Subtração, num 1 = ' + txtNum1.Text + ', num2 = ' + txtNum2.Text + ', Resultado = ' + txtResultado.Text);
    end;
